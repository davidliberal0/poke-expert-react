      ...
      <div className="landing-title-box text-white rounded-br-xl flex justify-center items-center">
        <div>
          <div className="github-link  border border-gray-700 rounded-3xl inline pl-10 pr-9 pt-2 pb-2 text-gray-300 hover:bg-neutral-900">
            <a href="https://github.com/davidliberal0/poke-expert-react">Dive Deeper Behind the Client</a>
            <div className="seperator inline border border-gray-300 mr-4 ml-4" role="seperator"></div>
            <a href="https://github.com/davidliberal0/poke-expert-react">Read Code <span className=" pl-1 text-lg">→</span></a>
          </div>
          <div className="mt-8">
          ...
          <div>
            ...
            <button type="button" class="build-button bg-red-700 rounded-xl text-white hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-bold rounded px-4 py-2 text-center mr-2 mb-2">
              Start searching
            </button>
          </div>
        </div>
